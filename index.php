                        ...
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="images/slider/fornt-img/depositphotos_36013297-stock-photo-various-spices-selection.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1>no chemicals, no pesticides</h1>
                                        <div class="cr__btn">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="images/slider/fornt-img/vegi.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="images/slider/fornt-img/oil-ranking-feat.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
